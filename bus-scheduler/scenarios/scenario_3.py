scenario = {
    ...
    "description": "10 buses going Bengaluru→Kochi (15 min spacing), only 4 going Kochi→Bengaluru. Testshow the scheduler handles uneven traffic across directions.",
    "route": {
        "segments": [
    ...
    "buses": [
        ...
        {"id": "bus-BK-10", "operator": "kpn", "direction": "BK", "departure": "21:15"},
        {
            "id": "bus-KB-01",
            "operator": "freshbus",
            "direction": "KB",
        ...
        {"id": "bus-KB-03", "operator": "kpn", "direction": "KB", "departure": "20:10"},
        {
            "id": "bus-KB-04",
            "operator": "freshbus",
            "direction": "KB",
